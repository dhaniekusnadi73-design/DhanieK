...
const ADMIN_SECRET = (process.env.ADMIN_SECRET || (isProduction ? "" : "dev-admin-secret")).trim();
  ...
  const response = await fetch("https://api.openai.com/v1/responses", {
    ...
    body: JSON.stringify({
      ...
      input: [
        {
          role: "system",
          content: "Buat soal pilihan ganda berbahasa Indonesia sesuai kurikulum Indonesia. Perhatikan semester, variasikan stimulus, topik, opsi jawaban, dan pembahasan agar setiap generate terasa berbeda. Output harus JSON valid saja."
        },
        {
          role: "user",
